...
import { Plus, Settings, Search, Trash2, Copy, Edit, Home, Sparkles, Lock, Unlock, Eye, EyeOff, Printer } from "lucide-react";
                  ...
                  <div className="flex items-center gap-6 justify-between w-full md:w-auto md:border-l md:border-gray-100 md:pl-6">
                    ...
                    <div className="flex gap-2 items-center">
                      <button
                        ...
                        className="px-3 py-2 bg-teal-50 border border-teal-100 hover:bg-teal-100 font-bold text-xs text-teal-800 rounded-xl flex items-center gap-1.5 active:scale-95 transition-all cursor-pointer shadow-sm"
                        title="Save & Download Quote as PDF"
                      >
